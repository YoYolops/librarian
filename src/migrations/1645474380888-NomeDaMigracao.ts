...
export class NomeDaMigracao1645474380888 implements MigrationInterface {
    name = 'NomeDaMigracao1645474380888'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_personal_data" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "name" character varying NOT NULL, CONSTRAINT "REL_1abe1c4ec84d6eadcedc865a02" UNIQUE ("user_id"), CONSTRAINT "PK_fc4821895c2d37e8d15e0f3091f" PRIMARY KEY ("id"))`);
